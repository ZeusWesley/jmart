                                    ...
                                    <div class="title_wrapper">
                                        ...
                                        <?php if ($show_meta): ?>
											...
											<span class="fn" itemprop="name"><a
                                                        href="<?php echo get_author_posts_url(get_the_author_meta('ID')); ?>"><?php the_author_meta('display_name'); ?></a></span>
										</span>
                                                    <?php endif; ?>
											...
											<meta itemprop="dateModified" content="<?php echo get_the_date('c'); ?>"/>
                                                    ...
                                                    <?php if (mfn_opts_get('mfn-seo-schema-type')): ?>
                                                        ...
                                                        <div itemprop="publisher" itemscope
                                                            ...
                                                            <div itemprop="logo" itemscope
                                                                ...
                                                                <img src="<?php mfn_opts_show('logo-img') ?>"
                                                                     itemprop="url"
                                                                     content="<?php mfn_opts_show('logo-img') ?>"/>
                                                            </div>
                                                ...
                                                <?php if (isset($single_meta['categories'])): ?>
                                                    <div class="category meta-categories">
                                                        <span class="cat-btn"><?php echo $translate['categories']; ?> <i
                                                                    class="icon-down-dir"></i></span>
                                                        <div class="cat-wrapper"><?php echo get_the_category_list(); ?></div>
                                                    </div>

                                                    <div class="category mata-tags">
                                                        <span class="cat-btn"><?php echo $translate['tags']; ?> <i
                                                                    class="icon-down-dir"></i></span>
